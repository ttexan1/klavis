...
from ..types.jira_o_auth_success_response import JiraOAuthSuccessResponse
...
class JiraOauthClient:
    ...
    def jira_o_auth_callback(
        ...
        *,
        ...
        """
        _response = self._raw_client.jira_o_auth_callback(
    ...
    def refresh_jira_token(
        ...
        """
        _response = self._raw_client.refresh_jira_token(instance_id=instance_id, request_options=request_options)
        return _response.data
...
class AsyncJiraOauthClient:
    ...
    async def jira_o_auth_callback(
        self,
        *,
        code: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
        ...
        async def main() -> None:
            await client.jira_oauth.jira_o_auth_callback()


        asyncio.run(main())
        """
        _response = await self._raw_client.jira_o_auth_callback(
            code=code, state=state, error=error, error_description=error_description, request_options=request_options
        )
        return _response.data
    ...
    async def refresh_jira_token(
        ...
        async def main() -> None:
            await client.jira_oauth.refresh_jira_token(
                instance_id="instance_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.refresh_jira_token(instance_id=instance_id, request_options=request_options)
        return _response.data
