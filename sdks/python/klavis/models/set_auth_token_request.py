...
class SetAuthTokenRequest(BaseModel):
    ...
    SetAuthTokenRequest
    """ # noqa: E501
    instance_id: StrictStr = Field(description="The unique identifier for the connection instance", alias="instanceId")
    auth_token: StrictStr = Field(description="The authentication token to save", alias="authToken")
    __properties: ClassVar[List[str]] = ["instanceId", "authToken"]
