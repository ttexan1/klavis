...
class CallToolResult(BaseModel):
    ...
    is_error: Optional[StrictBool] = Field(default=False, description="Whether the tool call was successful", alias="isError")
    __properties: ClassVar[List[str]] = ["content", "isError"]
