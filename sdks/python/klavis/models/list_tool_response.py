...
class ListToolResponse(BaseModel):
    ...
    ListToolResponse
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the list tools request was successful")
    tools: List[Any] = Field(description="List of tools available for the MCP server")
    __properties: ClassVar[List[str]] = ["success", "tools"]
