...
from ..types.asana_o_auth_success_response import AsanaOAuthSuccessResponse
...
class AsanaOauthClient:
    ...
    def asana_o_auth_callback(
        ...
        *,
        ...
        """
        _response = self._raw_client.asana_o_auth_callback(
    ...
    def refresh_asana_token(
        ...
        """
        _response = self._raw_client.refresh_asana_token(instance_id=instance_id, request_options=request_options)
        return _response.data
...
class AsyncAsanaOauthClient:
    ...
    async def asana_o_auth_callback(
        self,
        *,
        code: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
        ...
        async def main() -> None:
            await client.asana_oauth.asana_o_auth_callback()


        asyncio.run(main())
        """
        _response = await self._raw_client.asana_o_auth_callback(
            code=code, state=state, error=error, request_options=request_options
        )
        return _response.data
    ...
    async def refresh_asana_token(
        ...
        async def main() -> None:
            await client.asana_oauth.refresh_asana_token(
                instance_id="instance_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.refresh_asana_token(instance_id=instance_id, request_options=request_options)
        return _response.data
