...
class SalesforceOauthClient:
    ...
    def salesforce_o_auth_callback(
        ...
        *,
        ...
        """
        _response = self._raw_client.salesforce_o_auth_callback(
    ...
    def refresh_salesforce_token(
        ...
        """
        _response = self._raw_client.refresh_salesforce_token(instance_id=instance_id, request_options=request_options)
        return _response.data
...
class AsyncSalesforceOauthClient:
    ...
    async def salesforce_o_auth_callback(
        ...
        *,
        ...
        async def main() -> None:
            await client.salesforce_oauth.salesforce_o_auth_callback()


        asyncio.run(main())
        """
        _response = await self._raw_client.salesforce_o_auth_callback(
            code=code, state=state, error=error, error_description=error_description, request_options=request_options
        )
        return _response.data
    ...
    async def refresh_salesforce_token(
        ...
        async def main() -> None:
            await client.salesforce_oauth.refresh_salesforce_token(
                instance_id="instance_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.refresh_salesforce_token(
