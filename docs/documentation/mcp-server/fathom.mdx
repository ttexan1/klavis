  ...
  <Tab title="API">
    <Steps>
      ...
      <Step title="Authenticate">
        ...
        <Note>
          Get your Fathom API key from your [Fathom Developer Console](https://fathom.io/).
        </Note>
        
        <Check>
          🎉 **Your Fathom MCP Server is ready!** Once authentication is complete, you can use your MCP server URL with any MCP-compatible client.
        </Check>
      </Step>
