    ...
    <Steps>
      ...
      <Step title="Create a server instance">
        <CodeGroup>
          ...
          // Create a Google Calendar MCP server instance
          const googleCalendarServer = await klavis.mcpServer.createServerInstance({
        ...
        <Info>
          **Response Information**: The API returns:
          - `serverUrl`: The URL for connecting your MCP client to Google Calendar
          - `instanceId`: Unique identifier for your server instance
          - `oauthUrl`: OAuth authorization URL for Google Calendar authentication
        </Info>
      </Step>
