    ...
    <Steps>
      ...
      <Step title="Create a server instance">
        <CodeGroup>
          ...
          // Create a Google Drive MCP server instance
          const googleDriveServer = await klavis.mcpServer.createServerInstance({
        ...
        <Info>
          **Response Information**: The API returns:
          - `serverUrl`: The URL for connecting your MCP client to Google Drive
          - `instanceId`: Unique identifier for your server instance
          - `oauthUrl`: OAuth authorization URL for Google Drive authentication
        </Info>
      </Step>
