...
<Card title="Strata MCP Server" icon="layer-group" horizontal href="#multi-app-integration">
  Optimized to handle tool overload and context window limits. Click to jump >
</Card>

<Card title="Traditional MCP Server" icon="terminal" horizontal href="#individual-app-integration">
  Designed primarily for 1:1 API-to-tool mappings. Click to jump >
</Card>
