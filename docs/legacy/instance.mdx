...
<Info>
This is the legacy approach to MCP servers. We recommend using [Strata MCP Server](/documentation/quickstart#strata) for better tool management and context window optimization.
</Info>
...
<Info>
For the recommended approach with better tool management and progressive discovery, see [Strata MCP Server](/documentation/quickstart#strata).
</Info>
