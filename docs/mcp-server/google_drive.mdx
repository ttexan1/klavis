---
title: 'Google Drive'
description: 'Connect AI agents to Google Drive for file storage and collaboration'
---
...
<Tabs>
  <Tab title="API">
    <Steps>
      ...
      <Step title="Create a Strata MCP Server with Google Drive">
        <CodeGroup>
          ```python Python
      ...
      <Step title="Authenticate">
        ...
        <Check>
          🎉 **Your Google Drive MCP Server is ready!** Once authentication is complete, you can use your MCP server URL with any MCP-compatible client.
        </Check>
      </Step>
