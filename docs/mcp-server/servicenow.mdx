...
See ServiceNow official REST API documentation for available endpoints: [ServiceNow REST API](https://www.servicenow.com/docs/bundle/zurich-api-reference/page/build/applications/concept/api-rest.html).
