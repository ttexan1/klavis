...
<CardGroup cols={1}>
  ...
  <Card title="How to use MCP Server in Github Copilot" href="developer/github_copilot">
    Learn how to integrate Klavis MCP Servers with Github Copilot for enhanced AI workflow experience.
  </Card>
  ...
  <Card title="How to use MCP Server in Windsurf IDE" href="developer/windsurf">
