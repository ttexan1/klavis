---
title: "Gemini CLI"
description: "Connect Klavis MCP Servers with Gemini CLI in minutes and supercharge your AI coding experience"
---
<img
  className="block dark:hidden"
  src="/images/knowledge-base/gemini_cli/Gemini_CLI.png"
  alt="Gemini CLI with Klavis MCP Servers"
/>
<img
...
<Steps>
  <Step title="Access Klavis MCP Servers">
    ...
    <img
      src="/images/knowledge-base/gemini_cli/step1.png"
  ...
  <Step title="Complete Authentication">
    <img
      src="/images/knowledge-base/gemini_cli/step2.png"
      alt="Klavis MCP Servers page"
    />
    
    <img
      src="/images/knowledge-base/gemini_cli/step3.png"
      alt="OAuth authentication flow"
    />
    
    <img
      src="/images/knowledge-base/gemini_cli/step4.png"
  ...
  <Step title="Configure Gemini CLI">
    ...
    <img
      src="/images/knowledge-base/gemini_cli/step5.png"
      alt="Gemini CLI Settings"
    />
  ...
  <Step title="Verify Tools Loading">
    ...
    <img
      src="/images/knowledge-base/gemini_cli/step6.png"
      alt="MCP Configuration in Gemini CLI"
    />
  ...
  <Step title="Start Using in Gemini CLI Chat">
    <img
      src="/images/knowledge-base/gemini_cli/step7.png"
      alt="Using MCP Server in Gemini CLI Chat"
    />
    ...
    <Tip>
      🎯 Gemini CLI Chat automatically detects when to use your MCP server tools based on context - no need to specify tool names!
    </Tip>
  </Step>

  <Step title="Happy Building! 🎉">
    You're all set! Your MCP server is now integrated with Gemini CLI.
  </Step>
</Steps>
