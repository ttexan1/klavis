---
title: "Windsurf"
description: "Connect Klavis MCP Servers with Windsurf IDE in minutes and supercharge your AI coding experience"
---
<img
  className="block dark:hidden"
  src="/images/knowledge-base/windsurf/windsurf.png"
  alt=" Windsurf IDE with Klavis MCP Servers"
/>
<img
...
<Steps>
  <Step title="Access Klavis MCP Servers">
    ...
    <img
      src="/images/knowledge-base/windsurf/step1.png"
  ...
  <Step title="Complete Authentication">
    <img
      src="/images/knowledge-base/windsurf/step2.png"
      alt="Klavis MCP Servers page"
    />
    
    <img
      src="/images/knowledge-base/windsurf/step3.png"
      alt="OAuth authentication flow"
    />
    
    <img
      src="/images/knowledge-base/windsurf/step4.png"
  ...
  <Step title="Configure Windsurf IDE">
    ...
    <img
      src="/images/knowledge-base/windsurf/step5.png"
      alt="Windsurf IDE Settings"
    />

    Navigate to **Cascade** and click **Manage MCPs** > **View raw config**.

    <img
      src="/images/knowledge-base/windsurf/step6.png"
      alt="Windsurf Cascade and MCPs settings"
    />

    <img
      src="/images/knowledge-base/windsurf/step7.png"
      alt="Get Raw Config file in Windsurf"
    />
    
    Paste Your Server URL to **mcp_config.json** file like the screenshot below.

    <img
      src="/images/knowledge-base/windsurf/step8.png"
      alt="mcp_config.json file in Windsurf IDE"
    />
  ...
  <Step title="Verify Tools Loading">
    ...
    <img
      src="/images/knowledge-base/windsurf/step9.png"
      alt="MCP Configuration in Windsurf"
    />
  ...
  <Step title="Start Using in Windsurf Chat">
    <img
      src="/images/knowledge-base/windsurf/step10.JPG"
      alt="Using MCP Server in Windsurf Chat"
    />
    ...
    <Tip>
      🎯 Windsurf Chat automatically detects when to use your MCP server tools based on context - no need to specify tool names!
    </Tip>
  </Step>

  <Step title="Happy Building! 🎉">
    You're all set! Your MCP server is now integrated with Windsurf IDE.
  </Step>
</Steps>
