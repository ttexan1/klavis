...
<Tip>
You can also use the remote MCP server for Klavis documentation at `https://www.klavis.ai/docs/mcp`. To connect directly from your IDE, update your `mcp.json` like below:

```json
"klavisai": {
  "url": "https://www.klavis.ai/docs/mcp"
}
```
</Tip>
...
Copy the following content and paste it in the prompt for your coding assistant: https://www.klavis.ai/docs/llms-full.txt
